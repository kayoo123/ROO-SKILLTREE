...
function shareLink() {
	q_path = if (HolyLight[1] !== 0) { "&HolyLight=" + HolyLight[1] } + if (DemonBane[1] !== 0) { "&DemonBane=" + DemonBane[1] } + if (Heal[1] !== 0) { "&Heal=" + Heal[1] } + if (Teleport[1] !== 0) { "&Teleport=" + Teleport[1] } + if (Blessing[1] !== 0) { "&Blessing=" + Blessing[1] } + if (SignumCrucis[1] !== 0) { "&SignumCrucis=" + SignumCrucis[1] } + if (Angelus[1] !== 0) { "&Angelus=" + Angelus[1] } + if (IncreaseAgility[1] !== 0) { "&IncreaseAgility=" + IncreaseAgility[1] } + if (KyrieEleison[1] !== 0) { "&KyrieEleison=" + KyrieEleison[1]}
